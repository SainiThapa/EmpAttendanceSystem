"""
Django settings for Attendance_Emp project.
...
SECRET_KEY = 'django-insecure-#a-t52)+th@1=m-jt*+perz&)8*fv5u9o_(c10@!-4o_t##&i+'
...
WSGI_APPLICATION = 'Attendance_Emp.wsgi.application'
